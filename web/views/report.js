function load() {
    $.getJSON("web_report.json", function (data) {
        ...
        $('<a href="data:' + data_str + '" download="API Compliance Report.json"><button style="margin:10px; width:100%" class="downbtn"><i class="fa fa-download"></i> Download Report</button></a>').prependTo('#json_div');
